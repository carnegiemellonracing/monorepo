...
cmr_canRXMeta_t canRXMeta[] = {
    ...
    [CANRX_PACK_CELL_VOLTAGES] =  { .canID = CMR_CANID_HVBMS_MINMAX_CELL_VOLTAGE, .timeoutError_ms = 4000, .timeoutWarn_ms = 2000 },
...
void canInit(void) {
    ...
    const cmr_canFilter_t canFilters[] = {
        ...
        { .isMask = false, .rxFIFO = CAN_RX_FIFO0, .ids = { CMR_CANID_AFC1_DRIVER_TEMPS, CMR_CANID_HVBMS_MINMAX_CELL_TEMPS, CMR_CANID_VSM_STATUS, CMR_CANID_HEARTBEAT_MEMORATOR } },
        ...
        { .isMask = false, .rxFIFO = CAN_RX_FIFO1, .ids = { CMR_CANID_VSM_SENSORS, CMR_CANID_HVBMS_MINMAX_CELL_VOLTAGE, CMR_CANID_HVBMS_LOW_VOLTAGE, CMR_CANID_DRS_STATE } },
