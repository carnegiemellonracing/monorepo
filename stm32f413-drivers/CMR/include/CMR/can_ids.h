...
typedef enum {
    ...
    CMR_CAN_HVC_ERROR_PACK_OVERVOLT = 0x303, 
    CMR_CAN_HVC_ERROR_CELL_OVERVOLT = 0x304,
    CMR_CAN_HVC_ERROR_CELL_OVERTEMP = 0x305,
    ...
    */
    ...
    CMR_CANID_AS_RES = 0x707,
    CMR_CANID_AS_PRESSURE_READINGS = 0x708,
    CMR_CANID_ASMS_STATE = 0x709,
    CMR_CANID_AUTONOMOUS_ACTION = 0x7A0,

    // TODO: change can IDs, out of range
...
typedef enum {
    CMR_CANID_EXTENDED_CUBEMARS_SET_DUTY = 0 << 8 | CONTROLLER_ID = 0x880,
    CMR_CANID_EXTENDED_CUBEMARS_SET_CURRENT = 1 << 8 | CONTROLLER_ID = 0x881,
    CMR_CANID_EXTENDED_CUBEMARS_SET_CURRENT_BRAKE = 2 << 8 | CONTROLLER_ID = 0x882,
    CMR_CANID_EXTENDED_CUBEMARS_SET_RPM = 3 << 8 | CONTROLLER_ID = 0x883,
    CMR_CANID_EXTENDED_CUBEMARS_SET_POS = 4 << 8 | CONTROLLER_ID = 0x884,
    CMR_CANID_EXTENDED_CUBEMARS_SET_ORIGIN_HERE = 5 << 8 | CONTROLLER_ID = 0x885,
    CMR_CANID_EXTENDED_CUBEMARS_SET_POS_SPD = 6 << 8 | CONTROLLER_ID = 0x886,
