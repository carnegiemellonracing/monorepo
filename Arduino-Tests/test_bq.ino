...
void autoAddressTwo() {
  ...
  byte autoaddr_5[6] = {0xD0, 0x03, 0x08, 0x02, 0x4E, 0xE5};
  byte autoaddr_6[7] = {0x90, 0x00, 0x03, 0x08, 0x00, 0x13, 0xdd};
  byte autoaddr_7[7] = {0x90, 0x01, 0x03, 0x08, 0x03, 0x52, 0x20};
  ...
  delay(500);
  byte autoaddr_9[7] = {0x80, 0x00, 0x03, 0x06, 0x01, 0x17, 0xBE};
  Serial3.write(autoaddr_9, sizeof(autoaddr_9));
  while(!Serial3.available()) {
    digitalWrite(13, HIGH);
    delay(100);
