...
/** @brief Broadcast CAN IDs */
    ...
    CMR_CANID_DAQ_FSM_DATA = 0x6F0,
    CMR_CANID_DAQ_VSM_SENSORS = 0x6F1,
    CMR_CANID_DAQ_DTI_ERROR_MESSAGES = 0x6F2,
    CMR_CANID_DAQ_AS_RES = 0x6F3,
    CMR_CANID_DAQ_AS_PRESSURE_READINGS = 0x6F4,
    CMR_CANID_DAQ_VSM_FIRST_ERROR = 0x6F5,
    CMR_CANID_DAQ_HVBMS_MINMAX_CELL_VOLTAGE = 0x6F6,
    CMR_CANID_DAQ_HVBMS_PACK_VOLTAGE = 0x6F7,
    CMR_CANID_DAQ_HVBMS_MINMAX_CELL_TEMPS = 0x6F8,
    CMR_CANID_DAQ_CDC_COULOMB_COUNTING = 0x6F9,
