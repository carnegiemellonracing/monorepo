...
typedef struct {
    ...
    uint8_t dtiFLErrorCode;  /**< @brief DTI FL Error Code */
    uint8_t dtiFRErrorCode;  /**< @brief DTI FR Error Code */
    uint8_t dtiRLErrorCode;  /**< @brief DTI RL Error Code */
    uint8_t dtiRRErrorCode;  /**< @brief DTI RR Error Code */
