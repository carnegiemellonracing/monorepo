...
typedef enum {
    ...
    */
    ...
    CMR_CANID_FRONT_SLIP_RATIOS = 0x7E6,
    CMR_CANID_REAR_SLIP_RATIOS = 0x7E7,
    CMR_CANID_FRONT_WHL_SETPOINTS = 0x7E8,
    CMR_CANID_REAR_WHL_SETPOINTS = 0x7E9,
    CMR_CANID_FRONT_WHL_VELS = 0x7EA,
    CMR_CANID_REAR_WHL_VELS = 0x7EB,
