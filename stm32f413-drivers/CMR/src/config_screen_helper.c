...
volatile config_menu_item_t config_menu_main_array[MAX_MENU_ITEMS] = {
    ...
    [TORQUE_BIAS_INDEX] = {
        ...
        .ESE_context_text_variable = "Torque Bias Percentage",
        .value = {
    ...
    [SLIP_RATIO_FRONT_INDEX] = {
        .name = "Front Slip Ratio",
        .ESE_background_color_variable = ESE_SLIP_RATIO_FRONT_BOX,
        .ESE_value_color_variable = ESE_SLIP_RATIO_FRONT_COLOR,
        .ESE_value_variable = ESE_SLIP_RATIO_FRONT_VAL,
        .ESE_context_text_variable = "Front Slip Ratio",
        .value = {
    ...
    [SLIP_RATIO_REAR_INDEX] = {
        .name = "Rear Slip Ratio",
        .ESE_background_color_variable = ESE_SLIP_RATIO_REAR_BOX,
        .ESE_value_color_variable = ESE_SLIP_RATIO_REAR_COLOR,
        .ESE_value_variable = ESE_SLIP_RATIO_REAR_VAL,
        .ESE_context_text_variable = "Rear Slip Ratio",
        .value = {
            .type = unsigned_integer,
            .value = 0
        },
    ...
    [K_POW_INDEX] = {
        .name = "K Pow",
        .ESE_background_color_variable = ESE_K_POW_BOX,
        .ESE_value_color_variable = ESE_K_POW_COLOR,
        .ESE_value_variable = ESE_K_POW_VAL,
        .ESE_context_text_variable = "K Pow",
    ...
    [ACCEL_KP_INDEX] = {
        .name = "Accel Kp",
        .ESE_background_color_variable = ESE_ACCEL_KP_BOX,
        .ESE_value_color_variable = ESE_ACCEL_KP_COLOR,
        .ESE_value_variable = ESE_ACCEL_KP_VAL,
        .ESE_context_text_variable = "Accel Kp",
        .value = {
            .type = unsigned_integer,
            .value = 20
        },
    ...
    [ACCEL_KI_INDEX] = {
        .name = "Accel Ki",
        .ESE_background_color_variable = ESE_ACCEL_KI_BOX,
        .ESE_value_color_variable = ESE_ACCEL_KI_COLOR,
        .ESE_value_variable = ESE_ACCEL_KI_VAL,
        .ESE_context_text_variable = "Accel Ki",
        .value = {
            .type = float_1_decimal,
            .value = 0
        },
