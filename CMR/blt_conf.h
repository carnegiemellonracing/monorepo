...
// CMR SPECIFICS
#define LED_BLINK_GPIO (GPIOA)
#define LED_BLINK_PIN (GPIO_PIN_5)
#define CMR_CAN_INTERFACE (2)
#define CMR_CAN_RX_GPIO (GPIOB)
#define CMR_CAN_RX_PIN (GPIO_PIN_12)
#define CMR_CAN_TX_GPIO (GPIOB)
#define CMR_CAN_TX_PIN (GPIO_PIN_13)
...
#define BOOT_COM_CAN_TX_MSG_ID          (0x7E8 /*| 0x80000000*/)
/** \brief Configure number of bytes in the target->host CAN message. */
#define BOOT_COM_CAN_TX_MAX_DATA        (8)
/** \brief Configure CAN message ID host->target. */
#define BOOT_COM_CAN_RX_MSG_ID          (0x7E9 /*| 0x80000000*/)
/** \brief Configure number of bytes in the host->target CAN message. */
#define BOOT_COM_CAN_RX_MAX_DATA        (8)
/** \brief Select the desired CAN peripheral as a zero based index. */
#define BOOT_COM_CAN_CHANNEL_INDEX      (CMR_CAN_INTERFACE-1)
