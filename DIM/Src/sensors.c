...
static cmr_sensor_t sensors[SENSOR_CH_LEN] = {
    [SENSOR_CH_TPOS_L_U8] = {
        ...
        .readingMax = 2320,
        .outOfRange_pcnt = 10,
        .warnFlag = CMR_CAN_WARN_DIM_TPOS_L },
    [SENSOR_CH_TPOS_R_U8] = { .conv = adcToUInt8, .sample = sampleADCSensor, .readingMin = 200, .readingMax = 2280, .outOfRange_pcnt = 10, .warnFlag = CMR_CAN_WARN_DIM_TPOS_R },
    [SENSOR_CH_BPOS_U8] = { .conv = adcToUInt8, .sample = sampleADCSensor, .readingMin = 365, .readingMax = 1651, .outOfRange_pcnt = 10, .warnFlag = CMR_CAN_WARN_DIM_BPOS },
    [SENSOR_CH_BPRES_PSI] = { .conv = adcToBPres_PSI, .sample = sampleADCSensor, .readingMin = 0, .readingMax = CMR_ADC_MAX, .outOfRange_pcnt = 10, .warnFlag = CMR_CAN_WARN_DIM_BPRES },
    [SENSOR_CH_SWANGLE_DEG_FL] = { .conv = adcToYaw_FL, .sample = sampleADCSensorSwangle, .readingMin = SWANGLE_90DEG_LEFT, .readingMax = SWANGLE_90DEG_RIGHT, .outOfRange_pcnt = 10, .warnFlag = CMR_CAN_WARN_DIM_SWANGLE },
    [SENSOR_CH_SWANGLE_DEG_FR] = { .conv = adcToYaw_FR, .sample = sampleADCSensorSwangle, .readingMin = SWANGLE_90DEG_LEFT, .readingMax = SWANGLE_90DEG_RIGHT, .outOfRange_pcnt = 10, .warnFlag = CMR_CAN_WARN_DIM_SWANGLE },
    ...
    [SENSOR_CH_TPOS_IMPLAUS] = { .conv = NULL, .sample = sampleTPOSDiff,
                                 ...
                                 .readingMax = 2600,
                                 .warnFlag = CMR_CAN_WARN_DIM_TPOS_IMPLAUSIBLE },
    [SENSOR_CH_BPP_IMPLAUS] = { .conv = NULL, .sample = sampleBrakeImplaus,
                                .readingMin = 0,  // output is typically 2V max
                                .readingMax = 2600,
                                .warnFlag = CMR_CAN_WARN_DIM_BPP },
