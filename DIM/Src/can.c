...
void canInit(void) {
    ...
    const cmr_canFilter_t canFilters[] = {
        ...
        { .isMask = false, .rxFIFO = CAN_RX_FIFO0, .ids = { CMR_CANID_DTI_FL_ACLIMS, CMR_CANID_DTI_FR_ACLIMS, CMR_CANID_DTI_RL_ACLIMS, CMR_CANID_DTI_RR_ACLIMS } },
        { .isMask = false, .rxFIFO = CAN_RX_FIFO0, .ids = { CMR_CANID_DTI_FL_CONTROL_STATUS, CMR_CANID_DTI_FR_CONTROL_STATUS, CMR_CANID_DTI_RL_CONTROL_STATUS, CMR_CANID_DTI_RR_CONTROL_STATUS } },
        { .isMask = false, .rxFIFO = CAN_RX_FIFO0, .ids = { CMR_CANID_DTI_FL_CURRENT, CMR_CANID_DTI_FR_CURRENT, CMR_CANID_DTI_RL_CURRENT, CMR_CANID_DTI_RR_CURRENT } },
        { .isMask = false, .rxFIFO = CAN_RX_FIFO0, .ids = { CMR_CANID_DTI_FL_DCLIMS, CMR_CANID_DTI_FR_DCLIMS, CMR_CANID_DTI_RL_DCLIMS, CMR_CANID_DTI_RR_DCLIMS } },
        { .isMask = false, .rxFIFO = CAN_RX_FIFO0, .ids = { CMR_CANID_DTI_FL_DRIVE_EN, CMR_CANID_DTI_FR_DRIVE_EN, CMR_CANID_DTI_RL_DRIVE_EN, CMR_CANID_DTI_RR_DRIVE_EN } },
        { .isMask = false, .rxFIFO = CAN_RX_FIFO0, .ids = { CMR_CANID_DTI_FL_ERPM, CMR_CANID_DTI_FR_ERPM, CMR_CANID_DTI_RL_ERPM, CMR_CANID_DTI_RR_ERPM } },
        { .isMask = false, .rxFIFO = CAN_RX_FIFO0, .ids = { CMR_CANID_DTI_FL_IDIQ, CMR_CANID_DTI_FR_IDIQ, CMR_CANID_DTI_RL_IDIQ, CMR_CANID_DTI_RR_IDIQ } },
        { .isMask = false, .rxFIFO = CAN_RX_FIFO0, .ids = { CMR_CANID_DTI_FL_TEMPFAULT, CMR_CANID_DTI_FR_TEMPFAULT, CMR_CANID_DTI_RL_TEMPFAULT, CMR_CANID_DTI_RR_TEMPFAULT } },
