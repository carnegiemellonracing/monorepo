...
typedef enum {
    ...
    CMR_CANID_HEARTBEAT_COMPUTE = 0x105,    /**< @brief COMPUTE heatbeart. */
    ...
    */
    ...
    CMR_CANID_LVBMS_CELL_UNDERVOLTAGE = 0x7fc,
    CMR_CANID_LVBMS_CELL_OVERTEMP = 0x7fd,
    CMR_CANID_LVBMS_BUS_VOLTAGE = 0x7fe,
    CMR_CANID_LVBMS_CURRENT = 0x7ff,
} cmr_canID_t;
