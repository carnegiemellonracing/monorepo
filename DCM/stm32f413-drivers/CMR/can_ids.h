...
typedef enum {    
    ...
    CMR_CANID_CDC_VELOCITY_ESTIMATION1 = 0x2C2,      /**< @brief CDC (24e) Velocity estimation. */
    CMR_CANID_CDC_VELOCITY_ESTIMATION2 = 0x2D2,      /**< @brief CDC (24e) Velocity estimation. */
	CMR_CANID_CDC_POWER_SENSE = 0x305,				/**< @brief CDC (24e) power sense/ */
    ...
    */
    ...
    CMR_CANID_CONTROLS_CVXGEN_INFO = 0x7E6, 
    CMR_CANID_CONTROLS_CVXGEN_TORQUES = 0x7F0,
    CMR_CANID_CONTROLS_CVXGEN_CONVERGENCE = 0x7EE,
    ...
    CMR_CANID_FRONT_WHL_ANGLES = 0x7F4,
    CMR_CANID_REAR_WHL_ANGLES = 0x7F5,
