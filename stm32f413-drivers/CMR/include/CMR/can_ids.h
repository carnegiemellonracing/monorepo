...
typedef enum {
    CMR_CANID_EXTENDED_CUBEMARS_SET_DUTY = 0 << 8 | CONTROLLER_ID = 0x7ff,
    CMR_CANID_EXTENDED_CUBEMARS_SET_CURRENT = 1 << 8 | CONTROLLER_ID = 0x800,
    CMR_CANID_EXTENDED_CUBEMARS_SET_CURRENT_BRAKE = 2 << 8 | CONTROLLER_ID = 0x801,
    CMR_CANID_EXTENDED_CUBEMARS_SET_RPM = 3 << 8 | CONTROLLER_ID = 0x802,
    CMR_CANID_EXTENDED_CUBEMARS_SET_POS = 4 << 8 | CONTROLLER_ID = 0x803,
    CMR_CANID_EXTENDED_CUBEMARS_SET_ORIGIN_HERE = 5 << 8 | CONTROLLER_ID = 0x804,
    CMR_CANID_EXTENDED_CUBEMARS_SET_POS_SPD = 6 << 8 | CONTROLLER_ID = 0x805,
