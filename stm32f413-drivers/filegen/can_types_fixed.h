...
typedef struct {
    ...
    uint8_t HVITimeout:1; 
    uint8_t reserved:1; 

    uint8_t PTCTimeout:1; 
    uint8_t DIMTimeout:1; 
    uint8_t FSMTimeout:1; 
    uint8_t CDCTimeout:1; 
    uint8_t HVCTimeout:1; 
...
typedef struct {
    uint16_t pack_undervolt1:1; 
    uint16_t pack_overvolt1:1;
    uint16_t reserved:1; 
    uint16_t cell_overcurrent:1; 
    uint16_t cell_undervolt2:1; 
    uint16_t cell_overvolt2:1; 
    uint16_t cell_overtemp:1; 
    uint16_t bmb_fault:1; 
    uint16_t bmb_timeout:1; 
    ...
    uint8_t prechargeClosed:1;
    uint8_t negAIRClosed:1;
    uint8_t posAIRClosed:1; 
    uint8_t dischargeError:1; 
    uint8_t prechargeError:1; 
    uint8_t negAIRError:1; 
    uint8_t posAIRError:1; 
    uint8_t uptime_s; 
...
typedef struct {
    uint8_t bmb0_error:4;
    uint8_t bmb1_error:4;
    uint8_t bmb2_error:4;
    uint8_t bmb3_error:4;
    uint8_t bmb4_error:4;
    uint8_t bmb5_error:4;
    uint8_t bmb6_error:4;
    uint8_t bmb7_error:4;
    uint8_t bmb8_error:4;
    uint8_t bmb9_error:4;
    uint8_t bmb10_error:4;
    uint8_t bmb11_error:4;
    uint8_t bmb12_error:4;
    uint8_t bmb13_error:4;
    uint8_t bmb14_error:4;
    uint8_t bmb15_error:4;
...
typedef struct {
    uint16_t status_reserved:8;
    uint16_t systemready:1;
    uint16_t error:1;
    uint16_t warn:1;
    uint16_t quitdcon:1;
    uint16_t dcon:1;
    uint16_t quitinvon:1;
...
typedef struct {
    uint32_t mode:4; 
    uint32_t attitude_valid:1;
    uint32_t heading_valid:1;
    uint32_t velocity_valid:1;
    uint32_t position_valid:1;
    uint32_t vert_ref:1;
    uint32_t mag_ref:1;
    uint32_t gps1_vel_used:1;
    uint32_t gps1_pos_used:1;
    uint32_t gps1_hdt_used:1;
    uint32_t gps2_vel_used:1;
    uint32_t gsp2_pos_used:1;
    uint32_t gps2_hdt_used:1;
    uint32_t odo_used:1;
    uint32_t dvl_bt_used:1;
    uint32_t dvl_wt_used:1;
    uint32_t usbl_used:1;
