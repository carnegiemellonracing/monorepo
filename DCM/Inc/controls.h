...
void setTractionControl(uint8_t throttlePos_u8, uint16_t brakePressurePsi_u8, int16_t swAngle_deg, float leftRightBias_Nm,
...
void setYawRateAndTractionControl(uint8_t throttlePos_u8, uint16_t brakePressurePsi_u8, int16_t swAngle_deg,
    bool assumeNoTurn, bool ignoreYawRate, bool allowRegen, float critical_speed_mps);
