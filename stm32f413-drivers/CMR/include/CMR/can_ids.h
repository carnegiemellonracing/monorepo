...
typedef enum {
    CMR_CANID_EXTENDED_CUBEMARS_SET_DUTY,
    CMR_CANID_EXTENDED_CUBEMARS_SET_CURRENT,
    CMR_CANID_EXTENDED_CUBEMARS_SET_CURRENT_BRAKE,
    CMR_CANID_EXTENDED_CUBEMARS_SET_RPM,
    CMR_CANID_EXTENDED_CUBEMARS_SET_POS,
    CMR_CANID_EXTENDED_CUBEMARS_SET_ORIGIN_HERE,
    CMR_CANID_EXTENDED_CUBEMARS_SET_POS_SPD,
    CMR_CANID_EXTENDED_CUBEMARS_DATA
} cmr_canExtendedID_t;
